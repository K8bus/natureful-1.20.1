...
public class SawmillScreenHandler extends ScreenHandler {
    ...
    private List<SawingRecipe> availableRecipes;
    ...
    public SawmillScreenHandler(int syncId, PlayerInventory playerInventory, ScreenHandlerContext context) {
        super(ModScreenHandlers.SAWMILL_HANDLER, syncId);
    ...
    private void updateInput(Inventory input, ItemStack stack) {
        ...
        if (!stack.isEmpty()) {
            this.availableRecipes = this.world.getRecipeManager().getAllMatches(ModRecipes.SAWING, input, this.world);
        }
    }
    ...
    public ScreenHandlerType<?> getType() {
        return ModScreenHandlers.SAWMILL_HANDLER;
    }
    ...
    public ItemStack quickMove(PlayerEntity player, int slot) {
        ...
        if (slot2 != null && slot2.hasStack()) {
            ...
            } else if (this.world.getRecipeManager().getFirstMatch(ModRecipes.SAWING, new SimpleInventory(new ItemStack[]{itemStack2}), this.world).isPresent()) {
